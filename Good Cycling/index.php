...
<main>
  ...
  <div class="main-visual">
    <div class="main-img">
      <img src="img/main-visual.jpg" alt="メインビジュアル" />
    </div>
    <div class="main-text">
  ...
  <p class="readmore"><a href="newsindex.html">read-more</a></p>
  <div class="position">
    <div id="consept">
      <div class="content-title">
        <p>consept</p>
  ...
  <div class="fix-sp">
    <div class="apple-sp">
      <img src="img/アプリアイコン.png" alt="アプリアイコン" />
    </div>
    <p class="arrow-sp">↑↑↑↑</p>
  ...
  <div id="howuse" class="howuse">
    ...
    <div class="work-men">
      <img src="img/通勤_男性.jpg" alt="通勤男性" />
    </div>
  </div>
  ...
  <div id="area" class="area-top">
    ...
    <div class="phone-girl">
      <img src="img/女性_スマホ2.jpeg" alt="女性スマホ" />
    </div>
  </div>
  <div id="voice" class="voice-top">
    ...
    <p class="voice-read-more"><a href="voice.html">read-more</a></p>
  </div>
  <div id="qa" class="qa">
    <div class="content-title">
      <p>よくある質問</p>
      ...
      <div>
        ...
        <div class="accordion">
          ...
          <p class="readmore"><a href="qa.html">read-more</a></p>
        </div>
        <!-- ここまで -->
      </div>
    </div>
  ...
  <div class="fix-sp">
    <div class="apple-sp">
      <img src="img/app.png" alt="アプリアイコン" />
    </div>
    <p class="arrow-sp">↑↑↑↑</p>
    <p class="instol-sp">インストール</p>
  </div>
...
<footer>
  <div>
    <div class="sns">
      <ul>
        <li><a class="line-link" href="#">・LINE</a></li>
        <li><a class="instgram-link" href="#">・instagram</a></li>
        <li><a class="x-link" href="#">・X</a></li>
      </ul>
    </div>
    <div class="footer-link">
      <ul>
        <li><a class="news" href="#news">・news</a></li>
        <li><a class="consept" href="#consept">・consept</a></li>
        <li><a class="features" href="#features">・特徴</a></li>
        <li><a class="howuse-link" href="#howuse">・ご利用方法</a></li>
      </ul>
      <ul>
        <li><a class="area-link" href="#area">・対応地域</a></li>
        <li><a class="voice-link" href="#voice">・お客様の声</a></li>
        <li><a class="qa-link" href="#qa">・よくある質問</a></li>
        <li><a class="recautions-link" href="#recautions">・注意事項</a></li>
      </ul>
    </div>
  </div>
</footer>
<p class="copyright"><small>&copy; 2024 Good Cycling.</small></p>
